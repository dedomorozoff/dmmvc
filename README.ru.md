...
- **Переключатели функций** - Включение/отключение функций по необходимости ([docs/FEATURES.ru.md](docs/FEATURES.ru.md))
...
### Основное
- [Переключатели Функций](docs/FEATURES.ru.md) - Включение/выключение функций фреймворка
- [Быстрый Старт Функций](docs/QUICKSTART_FEATURES.ru.md) - Руководство по настройке функций
- [CLI Инструмент](docs/CLI.ru.md) - Команды генерации кода
- [Обновление Зависимостей](docs/UPDATING.ru.md) - Поддержка пакетов в актуальном состоянии
